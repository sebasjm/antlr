...
typedef	struct ANTLR3_BASE_TREE_struct
{
	...
	void					(*replaceChildren)			(struct ANTLR3_BASE_TREE_struct * parent, ANTLR3_UINT32 startChildIndex, ANTLR3_UINT32 stopChildIndex, struct ANTLR3_BASE_TREE_struct * t);

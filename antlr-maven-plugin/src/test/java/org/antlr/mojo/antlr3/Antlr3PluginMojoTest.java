...
public class Antlr3PluginMojoTest extends AbstractMojoTestCase
{
    ...
    {
        AbstractAntlr3PluginMojo mojo = new CompileAntlr3PluginMojo();
    ...
    public void testSimple() throws Exception
    {
        ...
        AbstractAntlr3PluginMojo mojo = (CompileAntlr3PluginMojo) lookupMojo( "antlr", testPom );
        deleteFile(mojo.getOutputDirectory());
        mojo.execute();
    ...
    private static final void deleteFile(File file) throws Exception {
        if (file.isDirectory()) {

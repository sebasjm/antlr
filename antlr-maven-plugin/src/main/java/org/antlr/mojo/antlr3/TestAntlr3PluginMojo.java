 ...
 */
public class TestAntlr3PluginMojo extends AbstractAntlr3PluginMojo
{

    /**
     * Specifies the Antlr directory containing grammar files.
     *
     * @parameter default-value="${basedir}/src/test/antlr"
     * @required
     */
     ...
     *
     * @parameter default-value="${project.build.directory}/generated-test-sources/antlr"
     * @required
     */
